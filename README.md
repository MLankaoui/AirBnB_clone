...
- File extension: `.py`
- Files and folders should start with `test_`.
- Organization: For `models/base.py`, place unit tests in `tests/test_models/test_base.py`.

## Execution Commands

To execute tests, you can use one of the following commands:
...
-   [Marouane Lankaoui](https://github.com/MLankaoui)